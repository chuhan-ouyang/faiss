...
int main(int argc, char** argv) {
    ...
    for (int nq = 1; nq <= 100; nq += (nq == 1 ? 9 : 10)) {
    ...
    std::string file_name = "2-IVFFlat-Quantizer-CPU-same_dim_" + std::to_string(d) + "_nb_" + std::to_string(nb) + "_k_" + std::to_string(k) + "_iter_" + std::to_string(num_searches) + "_nq_1_100_latencies.csv";
